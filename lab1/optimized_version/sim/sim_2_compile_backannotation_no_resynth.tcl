...
vsim -L /software/dk/nangate45/verilog/msim6.2g -sdftyp /tb_iir/DUT=../netlist/backannotation/synopsys/IIR_no_resynth.sdf work.tb_iir

vcd file ../vcd/IIR_no_resynth.vcd
vcd add /tb_iir/DUT/*
