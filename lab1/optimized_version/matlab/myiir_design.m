...
title('Transfer functions of the IIR filter','interpreter','latex', 'fontsize', 20)
hold on;
plot(w2/pi, 20*log10(abs(h2)),'r--');
grid on;
xlabel('Normalized frequency','interpreter','latex', 'fontsize', 12)
ylabel('dB','interpreter','latex', 'fontsize', 12)
legend('Design filter', 'Quantized filter', 'interpreter','latex', 'fontsize', 12)
