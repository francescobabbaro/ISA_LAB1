...
# Created by write_sdc on Thu Oct 28 09:26:00 2021

###################################################################
set sdc_version 2.1

set_units -time ns -resistance MOhm -capacitance fF -voltage V -current mA
set_load -pin_load 1.77921 [get_ports {DOUT[8]}]
set_load -pin_load 1.77921 [get_ports {DOUT[7]}]
set_load -pin_load 1.77921 [get_ports {DOUT[6]}]
set_load -pin_load 1.77921 [get_ports {DOUT[5]}]
set_load -pin_load 1.77921 [get_ports {DOUT[4]}]
set_load -pin_load 1.77921 [get_ports {DOUT[3]}]
set_load -pin_load 1.77921 [get_ports {DOUT[2]}]
set_load -pin_load 1.77921 [get_ports {DOUT[1]}]
set_load -pin_load 1.77921 [get_ports {DOUT[0]}]
set_load -pin_load 1.77921 [get_ports VOUT]
